...
predictive models (see example from \cite{dorie_automated_2019} developed in
...
selection and briefly review prior art. Then the methods
\autoref{sec:framework} sets causal model selection in the
\emph{potential outcome} framework and details the causal risks and
model-selection procedure. The next \autoref{sec:theory} gives theoretical
results. The results \autoref{sec:empirical_study} details a thorough empirical
study, covering many different settings. Finally, we
discuss the findings in the last \autoref{sec:discussion}.
%
