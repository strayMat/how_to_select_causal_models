...
\begin{figure}[!tb]
    ...
    \caption{\textbf{R-risk is robust to a wide range of effect ratio}: Kendall’s $\tau$ agreement with $\tau$-risk. Strong, medium and Weak Causal effect ratio are the tertiles of the absolute ratio causal effect to baseline response, ranging from 1 to 300. Appendix \ref{apd:effect_ratio} details this simulation.}\label{fig:effect_ratio_influence}
\end{figure}
...
\paragraph{Research question needing more work}
