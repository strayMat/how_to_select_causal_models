...
\begin{itemize}
    ...
    \item Project home page: \url{https://github.com/soda-inria/causal_model_selection}
    \item Operating system(s): Platform independent
    \item Programming language: Python
...
Detailed explanations on how to generate the datasets are available in the readme of the data section of our github: \url{https://github.com/soda-inria/caussim/tree/main/data}.

\begin{itemize}
    \item ACIC 2016: dataset provided through R package aciccomp2016: \url{https://github.com/vdorie/aciccomp}

    \item ACIC 2018: scaling subset from link to Synapse : \url{https://www.synapse.org/Synapse:syn11738767}

    \item TWINS: dataset from \url{https://github.com/AMLab-Amsterdam/CEVAE}, the version that we are using is on the following zenodo repository: \url{https://zenodo.org/records/14674618}.
      
    \item Caussim Dataset: generated dataset - instructions from \url{https://github.com/soda-inria/caussim}
\end{itemize}
\subsection{Experiments result data}

The result data generated by the experiments are available at a dedicated zenodo repository \url{https://zenodo.org/records/13765465}. We provide the data for the simulations and the semi-simulated datasets to allow an easy replication of the main graphic (Fig. \ref{fig:relative_kendalls_all_datasets}) in the result section (detailed steps on our github: \url{https://github.com/soda-inria/caussim/tree/main?tab=readme-ov-file#reports}).
