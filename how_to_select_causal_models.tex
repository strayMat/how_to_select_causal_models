...
\section{Objectives and structure of the paper}
...
data, going beyond prior work based on smaller simulation sets
...
to estimate both the nuisances and outcome models, then compute the risks on the
remaining test set for model selection (emprical argument in Appendix
