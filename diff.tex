...
%DIF ADD how_to_select_latex.tex   Sun Sep  1 18:58:08 2024
...
\cite{fang2019applying,dorie_automated_2019} }\hspace{0pt}%DIFAUXCMD
}\DIFdelend \DIFaddbegin \DIFadd{\mbox{%DIFAUXCMD
\cite{fang2019applying,dorie_automated_2019,leborgne2021g,ren2023comparing} }\hspace{0pt}%DIFAUXCMD
...
\mbox{%DIFAUXCMD
\cite{kaddour2022causal,chernozhukov2024applied}}\hspace{0pt}%DIFAUXCMD
...
\cite{kunzel_metalearners_2019}}\hspace{0pt}%DIFAUXCMD
.
}\DIFaddend 
...
\cite{robinson_rootnconsistent_1988}}\hspace{0pt}%DIFAUXCMD
plays an important role:
introducing two quantities}\DIFdelend \DIFaddbegin \DIFadd{G-computation is one choice of decomposition of the CATE estimation into a sequence of regressions, where the only statistical estimate is the response function $\mu_{a}(x)$ \mbox{%DIFAUXCMD
\cite[chapter 15]{chernozhukov2024applied}}\hspace{0pt}%DIFAUXCMD
. Other choices of decomposition exist, such as the R-decomposition \mbox{%DIFAUXCMD
\cite{robinson_rootnconsistent_1988}}\hspace{0pt}%DIFAUXCMD
. It introduces two new statistical estimates}\DIFaddend , the conditional mean outcome
...
\cite{johansson2022generalization}}\hspace{0pt}%DIFAUXCMD
...
\cite{foster2023orthogonal} }\hspace{0pt}%DIFAUXCMD
