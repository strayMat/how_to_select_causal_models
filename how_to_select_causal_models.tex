...
prior art. Then we anchor causal model selection in the \emph{potential
...
in biostatistics, \emph{eg} functional regression with splines
...
complex procedure than standard cross-validation used \emph{e.g.}~in machine
