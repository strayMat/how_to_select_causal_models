...
propensity scores \cite{rosenbaum_central_1983}.  However, outcome modeling go
...
\cite{charlson_new_1987}). We simulate a treatment beneficial (decreases $Y$)
...
errors between populations as noted by Proposition \ref{theory:prop:mu_risk_ipw_bound}
...
generate 1\,000 datasets based on this functions, with random overlap
