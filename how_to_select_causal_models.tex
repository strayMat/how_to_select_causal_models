...
\section{The R-risk, a reweighted oracle metric}\label{theory:r_risk_rewrite}
...
crucial for causal inference (positivity assumption
...
score (Appendix \ref{apd:motivation_ntv}).
