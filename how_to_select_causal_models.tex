...
\begin{abstract}
    ...
    We study such model selection procedures in practical settings:
    ...
    add noise to model selection. Drawing from an extensive empirical
    ...
    \textbf{Conclusions:} We outline that evaluating models for causal
    reasoning requires different procedures than standard predictive
    settings: using the so-called $R\text{-risk}$ and computing nuisance
    models with flexible estimators on the train set.
\end{abstract}
