...
%DIF ADD how_to_select_latex.tex   Sun Oct 20 12:39:00 2024
...
\emph{nuisances} \cite{chernozhukov_double_2018}\DIFdelbegin \DIFdel{; they are unknown }\DIFdelend \DIFaddbegin \DIFadd{. They are unknown and are estimated in practice thanks to statistical models (eg. linear models or forest based estimators)}\DIFaddend .
...
\DIFaddbegin \paragraph{\DIFadd{Limitations}}

\DIFadd{On average, the R-risk outperforms other risks, but it is not optimal for every
