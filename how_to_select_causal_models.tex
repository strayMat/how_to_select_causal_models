...
Charlson index \cite{charlson_new_1987}). We simulate a
...
for causal inference (related to $\eta$ in Proposition
\ref{theory:prop:mu_risk_ipw_bound}). Finally, we generate observed outcomes
adding Gaussian noise. We generate 1\,000 of such datasets, with
uniformly random overlap parameters. Example shown in Figure \ref{fig:simulation_examples} and details in
