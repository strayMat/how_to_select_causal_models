...
\usepackage{setspace} % double spaced required by journal
\doublespacing
...
\author[1,2,*]{Matthieu Doutreligne, PhD}
\author[1]{Gaël Varoquaux, PhD}
...
% XXX: for submission
%\twocolumn
% XXX: for submission (double spaced required)
%\setstretch{1.1}
\doublespacing
